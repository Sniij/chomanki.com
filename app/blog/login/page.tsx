    ...
    return (
        ...
        <div className="flex w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-900 to-black">
            <div className="lg:w-4/12 w-full z-1 bg-zinc-100 flex flex-col items-center text-black ">
                    ...
                    <div className="mt-16">
                    <Link href={"https://server.blog.chomanki.com/auth/login/github?prevPage=" + prevPage}>
                    <button type="button" 
                    ...
                    <div className="mt-4">
                    <Link href={"https://server.blog.chomanki.com/auth/login/google?prevPage=" + prevPage}>
                    <button type="button" 
