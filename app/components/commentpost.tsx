...
export function CommentPost(commentPostProps: CommentPostProps ) {
    ...
    return (
        <div className="relative duration-150 p-1 sm:p-4 rounded-lg text-gray-300 bg-zinc-900 hover:bg-zinc-800/20">
...
export function CommentReplyPost(commentReplyPostProps: CommentReplyPostProps ) {
    ...
    return (
        <div className="mt-5 duration-150 p-1 sm:p-4  rounded-lg text-gray-300 bg-zinc-900 hover:bg-zinc-800/20">
        ...
        <form onSubmit={(e) => {
            ...
            <textarea
                ...
                className="w-full min-h-20 bg-zinc-900/50 hover:bg-zinc-900 text-gray-300 break-words text-ellipsis overflow-hidden flex-grow h-32 p-2 border rounded-lg resize-y "
            ...
            <div className="flex justify-between z-0 mx-6 w-full">
                ...
                { commentReplyPostProps.isLoggedIn &&
                    <div className="mx-4 my-2 w-32 h-10 border rounded-lg duration-150 bg-zinc-900/50 hover:bg-zinc-900">
                        ...
                        type="submit"
                        disabled={!content.trim()}
                        className={`flex items-center justify-center h-full w-full  rounded-lg  ${!content.trim() ? ' text-gray-600' : ' text-blue-500 hover:bg-zinc-800'}`}
                        >      <p className="font-bold sm:text-base text-xs"> post </p>
                        </button>
                    </div>
                }
