...
export default function Redirect() {
    ...
    let redirect;
    if(searchParams)
        redirect = searchParams.get('redirect') ?? "/blog";
    ...
    return (
        <div className="flex w-screen h-screen  font-GSansLight font-bold overflow-hidden bg-gradient-to-tl from-black via-zinc-900 to-black">
            <div className="lg:w-4/12 w-full z-1 bg-zinc-100 flex flex-col items-center justify-center text-black ">
                    ...
                    <div className="">
                    <Link href= { LOCAL_BASE_URL + "/login/oauth2/authorization/github?prevPage=" + redirect}>
                    <button type="button" 
                    ...
                    <div className="mt-4">
                    <Link href={ LOCAL_BASE_URL + "/login/oauth2/authorization/google?prevPage=" + redirect}>
                    <button type="button" 
