...
---
        <table className="bg-zinc-50">
          ...
          <tr>
            <td>클래스</td>
            <td>변경 또는 확장 불가능한 클래스. 상속 또한 불가</td>
          </tr>
        </table> 
---
...
![[JAVA]객체지향심화-Abstraction(추상화)-1](https://github.com/Sniij/chomanki.com/blob/main/content/blog/images/abstraction-1.png)
