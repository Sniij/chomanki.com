...
일단 **추상 클래스란 메서드 시그니처만 존재하고,  
바디가 선언되어 있지 않은 추상 메서드를 포함하는 미완성 클래스**이다.
...
![Abstraction(추상화)-1](https://github.com/Sniij/chomanki.com/blob/main/content/blog/java-oop-abstraction/abstraction-1.png?raw=true)
